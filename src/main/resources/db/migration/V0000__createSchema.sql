...
CREATE TABLE gesuch_formular_eltern_aud (
	rev                INTEGER NOT NULL,
	gesuch_formular_id UUID    NOT NULL,
	id                 UUID    NOT NULL,
	revtype            SMALLINT,
	PRIMARY KEY (gesuch_formular_id, rev, id)
);

ALTER TABLE gesuch_formular_eltern_aud
ADD CONSTRAINT FK_gesuch_formular_eltern_aud_revinfo
	FOREIGN KEY (rev)
		REFERENCES revinfo(rev);

CREATE TABLE gesuch_formular_geschwister_aud (
	rev                INTEGER NOT NULL,
	gesuch_formular_id UUID    NOT NULL,
	id                 UUID    NOT NULL,
	revtype            SMALLINT,
...
ALTER TABLE gesuch_formular_geschwister_aud
ADD CONSTRAINT FK_gesuch_formular_geschwister_aud_revinfo
	FOREIGN KEY (rev)
		REFERENCES revinfo(rev);

CREATE TABLE gesuch_formular_kind_aud (
	rev                INTEGER NOT NULL,
	gesuch_formular_id UUID    NOT NULL,
	id                 UUID    NOT NULL,
	revtype            SMALLINT,
...
ALTER TABLE gesuch_formular_kind_aud
ADD CONSTRAINT FK_gesuch_formular_kind_aud_revinfo
	FOREIGN KEY (rev)
		REFERENCES revinfo(rev);

CREATE TABLE gesuch_formular_lebenslauf_item_aud (
	rev                INTEGER NOT NULL,
	gesuch_formular_id UUID    NOT NULL,
	id                 UUID    NOT NULL,
	revtype            SMALLINT,
...
ALTER TABLE gesuch_formular_lebenslauf_item_aud
ADD CONSTRAINT FK_gesuch_formular_lebenslauf_item_aud_revinfo
	FOREIGN KEY (rev)
		REFERENCES revinfo(rev);