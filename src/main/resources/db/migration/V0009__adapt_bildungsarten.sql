...
WHERE bildungsart = 'SCHULEN_FUER_ALLGEMEINBILDUNG' OR bildungsart = 'VOLLZEITBERUFSSCHULEN' OR
	  bildungsart = 'HOEHERE_BERUFSBILDUNG';
...
WHERE bildungsart = 'EIDGENOESSISCHES_BERUFSATTEST' OR bildungsart = 'EIDGENOESSISCHES_FAEHIGKEITSZEUGNIS';

UPDATE lebenslauf_item
SET fachrichtung = 'CHANGE_ME'
WHERE bildungsart = 'BACHELOR_HOCHSCHULE_UNI' OR bildungsart = 'BACHELOR_FACHHOCHSCHULE' OR bildungsart = 'MASTER';

UPDATE lebenslauf_item
SET titel_des_abschlusses = 'CHANGE_ME'
WHERE bildungsart = 'ANDERER_BILDUNGSABSCHLUSS' OR bildungsart = 'BACHELOR_FACHHOCHSCHULE' OR bildungsart = 'MASTER';
