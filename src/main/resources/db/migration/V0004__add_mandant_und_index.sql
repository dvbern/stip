...
ALTER TABLE adresse ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE ausbildung ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE auszahlung ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE dokument ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE eltern ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE familiensituation ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE geschwister ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE gesuch ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE gesuch_dokument ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE gesuch_formular ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE gesuchsperiode ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE kind ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE lebenslauf_item ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE partner ALTER COLUMN mandant DROP DEFAULT;
...
ALTER TABLE person_in_ausbildung ALTER COLUMN mandant DROP DEFAULT;
