...
public class PersonInAusbildungUpdateDto  implements Serializable {
  ...
  protected PersonInAusbildungUpdateDto(PersonInAusbildungUpdateDtoBuilder<?, ?> b) {
  ...
  public PersonInAusbildungUpdateDto() {
  }
  ...
  @JsonProperty(required = true, value = "nationalitaetId")
  @NotNull public UUID getNationalitaetId() {
  ...
  @JsonProperty(required = true, value = "korrespondenzSprache")
  @NotNull public ch.dvbern.stip.api.personinausbildung.type.Sprache getKorrespondenzSprache() {
   ...
   * Required nur wenn Land &#x3D; CH
   **/
  public PersonInAusbildungUpdateDto heimatortPLZ(String heimatortPLZ) {
  ...
  public static PersonInAusbildungUpdateDtoBuilder<?, ?> builder() {
    return new PersonInAusbildungUpdateDtoBuilderImpl();
  }

  private static final class PersonInAusbildungUpdateDtoBuilderImpl extends PersonInAusbildungUpdateDtoBuilder<PersonInAusbildungUpdateDto, PersonInAusbildungUpdateDtoBuilderImpl> {

    @Override
    protected PersonInAusbildungUpdateDtoBuilderImpl self() {
      return this;
    }

    @Override
    public PersonInAusbildungUpdateDto build() {
      return new PersonInAusbildungUpdateDto(this);
    }
  }

  public static abstract class PersonInAusbildungUpdateDtoBuilder<C extends PersonInAusbildungUpdateDto, B extends PersonInAusbildungUpdateDtoBuilder<C, B>>  {
    private AdresseDto adresse;
    private String sozialversicherungsnummer;
    private String vorname;
    private ch.dvbern.stip.api.common.type.Anrede anrede;
