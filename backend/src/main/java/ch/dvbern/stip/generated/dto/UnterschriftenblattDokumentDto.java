...
public class UnterschriftenblattDokumentDto  implements Serializable {
  ...
  @NotNull public ch.dvbern.stip.api.unterschriftenblatt.type.UnterschriftenblattDokumentTyp getDokumentTyp() {
    return dokumentTyp;
  }
  ...
  /**
   **/
  public UnterschriftenblattDokumentDto dokumente(List<@Valid DokumentDto> dokumente) {
