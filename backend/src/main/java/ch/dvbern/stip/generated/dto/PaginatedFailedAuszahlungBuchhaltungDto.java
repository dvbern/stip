...
public class PaginatedFailedAuszahlungBuchhaltungDto  implements Serializable {
  ...
  private @Valid List<@Valid FailedAuszahlungBuchhaltungDto> entries = new ArrayList<>();
  ...
  /**
   **/
  public PaginatedFailedAuszahlungBuchhaltungDto page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  /**
   **/
  public PaginatedFailedAuszahlungBuchhaltungDto pageSize(Integer pageSize) {
  ...
  /**
   **/
  public PaginatedFailedAuszahlungBuchhaltungDto totalEntries(Integer totalEntries) {
  ...
  /**
   **/
  public PaginatedFailedAuszahlungBuchhaltungDto entries(List<@Valid FailedAuszahlungBuchhaltungDto> entries) {
  ...
  @Valid public List<@Valid FailedAuszahlungBuchhaltungDto> getEntries() {
    return entries;
  }

  @JsonProperty("entries")
  public void setEntries(List<@Valid FailedAuszahlungBuchhaltungDto> entries) {
    this.entries = entries;
  }

  public PaginatedFailedAuszahlungBuchhaltungDto addEntriesItem(FailedAuszahlungBuchhaltungDto entriesItem) {
  ...
  public PaginatedFailedAuszahlungBuchhaltungDto removeEntriesItem(FailedAuszahlungBuchhaltungDto entriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedFailedAuszahlungBuchhaltungDto paginatedFailedAuszahlungBuchhaltung = (PaginatedFailedAuszahlungBuchhaltungDto) o;
  ...
  public String toString() {
    ...
    sb.append("class PaginatedFailedAuszahlungBuchhaltungDto {\n");
  ...
  public static abstract class PaginatedFailedAuszahlungBuchhaltungDtoBuilder<C extends PaginatedFailedAuszahlungBuchhaltungDto, B extends PaginatedFailedAuszahlungBuchhaltungDtoBuilder<C, B>>  {
    ...
    private Integer pageSize;
    private Integer totalEntries;
    private List<FailedAuszahlungBuchhaltungDto> entries = new ArrayList<>();
