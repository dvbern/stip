...
public class GesuchWithChangesDto  implements Serializable {
  ...
  /**
   **/
  public GesuchWithChangesDto beschwerdeHaengig(Boolean beschwerdeHaengig) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fallId, fallNummer, ausbildungId, gesuchsperiode, gesuchStatus, gesuchNummer, beschwerdeHaengig, id, aenderungsdatum, gesuchTrancheToWorkWith, bearbeiter, einreichedatum, delegierung, nachfristDokumente, changes);
  }
