...
public class GesuchsperiodeUpdateDto  implements Serializable {
  ...
  private @Valid Integer anzahlWocheLehre;
  private @Valid Integer anzahlWocheSchule;
   ...
   * 
   **/
  public GesuchsperiodeUpdateDto vermoegensfreibetrag(Integer vermoegensfreibetrag) {
   ...
   * 
   **/
  public GesuchsperiodeUpdateDto limiteEkFreibetragIntegrationszulag(Integer limiteEkFreibetragIntegrationszulag) {
   ...
   * 
   **/
  public GesuchsperiodeUpdateDto anzahlWocheLehre(Integer anzahlWocheLehre) {
    this.anzahlWocheLehre = anzahlWocheLehre;
    return this;
  }

  
  @JsonProperty("anzahlWocheLehre")
  public Integer getAnzahlWocheLehre() {
    return anzahlWocheLehre;
  }

  @JsonProperty("anzahlWocheLehre")
  public void setAnzahlWocheLehre(Integer anzahlWocheLehre) {
    this.anzahlWocheLehre = anzahlWocheLehre;
  }
   ...
   * 
   **/
  public GesuchsperiodeUpdateDto anzahlWocheSchule(Integer anzahlWocheSchule) {
    this.anzahlWocheSchule = anzahlWocheSchule;
    return this;
  }

  
  @JsonProperty("anzahlWocheSchule")
  public Integer getAnzahlWocheSchule() {
    return anzahlWocheSchule;
  }

  @JsonProperty("anzahlWocheSchule")
  public void setAnzahlWocheSchule(Integer anzahlWocheSchule) {
    this.anzahlWocheSchule = anzahlWocheSchule;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bezeichnungDe, gesuchsperiodeUpdate.bezeichnungDe) &&
        ...
        Objects.equals(this.vermoegensfreibetrag, gesuchsperiodeUpdate.vermoegensfreibetrag) &&
  ...
  public String toString() {
    ...
    sb.append("    anzahlWocheLehre: ").append(toIndentedString(anzahlWocheLehre)).append("\n");
    sb.append("    anzahlWocheSchule: ").append(toIndentedString(anzahlWocheSchule)).append("\n");
    sb.append("}");
    return sb.toString();
  }
