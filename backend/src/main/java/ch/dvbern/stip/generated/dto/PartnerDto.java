...
public class PartnerDto  implements Serializable {
  ...
  protected PartnerDto(PartnerDtoBuilder<?, ?> b) {
  ...
  public static PartnerDtoBuilder<?, ?> builder() {
    return new PartnerDtoBuilderImpl();
  }

  private static final class PartnerDtoBuilderImpl extends PartnerDtoBuilder<PartnerDto, PartnerDtoBuilderImpl> {

    @Override
    protected PartnerDtoBuilderImpl self() {
      return this;
    }
  ...
  public static abstract class PartnerDtoBuilder<C extends PartnerDto, B extends PartnerDtoBuilder<C, B>>  {
