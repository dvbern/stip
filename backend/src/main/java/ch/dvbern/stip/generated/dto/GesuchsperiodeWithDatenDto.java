...
public class GesuchsperiodeWithDatenDto  implements Serializable {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto limiteEkFreibetragIntegrationszulage(Integer limiteEkFreibetragIntegrationszulage) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto kinder0017(Integer kinder0017) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto jugendlicheErwachsene1824(Integer jugendlicheErwachsene1824) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto erwachsene2599(Integer erwachsene2599) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto vermoegensanteilInProzent(Integer vermoegensanteilInProzent) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto reduzierungDesGrundbedarfs(Integer reduzierungDesGrundbedarfs) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto limiteAlterAntragsstellerHalbierungElternbeitrag(Integer limiteAlterAntragsstellerHalbierungElternbeitrag) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto zweiterAuszahlungsterminMonat(Integer zweiterAuszahlungsterminMonat) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto zweiterAuszahlungsterminTag(Integer zweiterAuszahlungsterminTag) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto fristNachreichenDokumente(Integer fristNachreichenDokumente) {
  ...
  /**
   **/
  public GesuchsperiodeWithDatenDto fristUploadUnterschriftenblatt(Integer fristUploadUnterschriftenblatt) {
   ...
   * dd.MM.yyyy
   **/
  public GesuchsperiodeWithDatenDto stichtagVolljaehrigkeitMedizinischeGrundversorgung(LocalDate stichtagVolljaehrigkeitMedizinischeGrundversorgung) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bezeichnungDe, gesuchsperiodeWithDaten.bezeichnungDe) &&
        ...
        Objects.equals(this.fristUploadUnterschriftenblatt, gesuchsperiodeWithDaten.fristUploadUnterschriftenblatt) &&
        ...
        Objects.equals(this.id, gesuchsperiodeWithDaten.id) &&
