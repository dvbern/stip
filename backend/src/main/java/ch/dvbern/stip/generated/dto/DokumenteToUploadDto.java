...
public class DokumenteToUploadDto  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customDokumentTyps, required, unterschriftenblaetter, sbCanFehlendeDokumenteUebermitteln, gsCanDokumenteUebermitteln, sbCanUploadUnterschriftenblatt);
  }
