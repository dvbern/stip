...
public class EinnahmenKostenDto  implements Serializable {
  ...
  /**
   **/
  public EinnahmenKostenDto nettoerwerbseinkommen(BigDecimal nettoerwerbseinkommen) {
  ...
  /**
   **/
  public EinnahmenKostenDto fahrkosten(BigDecimal fahrkosten) {
   ...
   **/
  public EinnahmenKostenDto alimente(BigDecimal alimente) {
   ...
   **/
  public EinnahmenKostenDto zulagen(BigDecimal zulagen) {
   ...
   **/
  public EinnahmenKostenDto renten(BigDecimal renten) {
    this.renten = renten;
    return this;
  }
  ...
  /**
   **/
  public EinnahmenKostenDto eoLeistungen(BigDecimal eoLeistungen) {
  ...
  /**
   **/
  public EinnahmenKostenDto ergaenzungsleistungen(BigDecimal ergaenzungsleistungen) {
  ...
  /**
   **/
  public EinnahmenKostenDto beitraege(BigDecimal beitraege) {
   ...
   **/
  public EinnahmenKostenDto ausbildungskostenSekundarstufeZwei(BigDecimal ausbildungskostenSekundarstufeZwei) {
   ...
   **/
  public EinnahmenKostenDto ausbildungskostenTertiaerstufe(BigDecimal ausbildungskostenTertiaerstufe) {
  ...
  /**
   **/
  public EinnahmenKostenDto wohnkosten(BigDecimal wohnkosten) {
  ...
  /**
   **/
  public EinnahmenKostenDto personenImHaushalt(BigDecimal personenImHaushalt) {
