...
public class EinnahmenKostenDto  implements Serializable {
  ...
  protected EinnahmenKostenDto(EinnahmenKostenDtoBuilder<?, ?> b) {
 ...
 @Min(0) @Max(2147483647)  public Integer getSteuern() {
  ...
  public static EinnahmenKostenDtoBuilder<?, ?> builder() {
    return new EinnahmenKostenDtoBuilderImpl();
  }

  private static final class EinnahmenKostenDtoBuilderImpl extends EinnahmenKostenDtoBuilder<EinnahmenKostenDto, EinnahmenKostenDtoBuilderImpl> {

    @Override
    protected EinnahmenKostenDtoBuilderImpl self() {
      return this;
    }

    @Override
    public EinnahmenKostenDto build() {
      return new EinnahmenKostenDto(this);
    }
  }

  public static abstract class EinnahmenKostenDtoBuilder<C extends EinnahmenKostenDto, B extends EinnahmenKostenDtoBuilder<C, B>>  {
