...
public class DarlehenDokumentCreateDto  implements Serializable {
  ...
  protected DarlehenDokumentCreateDto(DarlehenDokumentCreateDtoBuilder<?, ?> b) {
    this.fileUpload = b.fileUpload;
  }

  public DarlehenDokumentCreateDto() {
  }
  ...
  public static DarlehenDokumentCreateDtoBuilder<?, ?> builder() {
    return new DarlehenDokumentCreateDtoBuilderImpl();
  }

  private static final class DarlehenDokumentCreateDtoBuilderImpl extends DarlehenDokumentCreateDtoBuilder<DarlehenDokumentCreateDto, DarlehenDokumentCreateDtoBuilderImpl> {

    @Override
    protected DarlehenDokumentCreateDtoBuilderImpl self() {
      return this;
    }

    @Override
    public DarlehenDokumentCreateDto build() {
      return new DarlehenDokumentCreateDto(this);
    }
  }

  public static abstract class DarlehenDokumentCreateDtoBuilder<C extends DarlehenDokumentCreateDto, B extends DarlehenDokumentCreateDtoBuilder<C, B>>  {
