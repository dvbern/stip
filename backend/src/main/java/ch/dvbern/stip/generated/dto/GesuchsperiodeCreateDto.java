...
public class GesuchsperiodeCreateDto  implements Serializable {
  ...
  protected GesuchsperiodeCreateDto(GesuchsperiodeCreateDtoBuilder<?, ?> b) {
  ...
  public GesuchsperiodeCreateDto() {
  }
  ...
  /**
   **/
  public GesuchsperiodeCreateDto fristUploadUnterschriftenblatt(Integer fristUploadUnterschriftenblatt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bezeichnungDe, gesuchsperiodeCreate.bezeichnungDe) &&
        ...
        Objects.equals(this.fristUploadUnterschriftenblatt, gesuchsperiodeCreate.fristUploadUnterschriftenblatt) &&
  ...
  public static GesuchsperiodeCreateDtoBuilder<?, ?> builder() {
    return new GesuchsperiodeCreateDtoBuilderImpl();
  }

  private static final class GesuchsperiodeCreateDtoBuilderImpl extends GesuchsperiodeCreateDtoBuilder<GesuchsperiodeCreateDto, GesuchsperiodeCreateDtoBuilderImpl> {

    @Override
    protected GesuchsperiodeCreateDtoBuilderImpl self() {
      return this;
    }

    @Override
    public GesuchsperiodeCreateDto build() {
      return new GesuchsperiodeCreateDto(this);
    }
  }

  public static abstract class GesuchsperiodeCreateDtoBuilder<C extends GesuchsperiodeCreateDto, B extends GesuchsperiodeCreateDtoBuilder<C, B>>  {
