...
public class PaginatedAusbildungsgangDto  implements Serializable {
  ...
  /**
   **/
  public PaginatedAusbildungsgangDto page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  /**
   **/
  public PaginatedAusbildungsgangDto pageSize(Integer pageSize) {
  ...
  /**
   **/
  public PaginatedAusbildungsgangDto totalEntries(Integer totalEntries) {
  ...
  public PaginatedAusbildungsgangDto addEntriesItem(AusbildungsgangDto entriesItem) {
  ...
  public PaginatedAusbildungsgangDto removeEntriesItem(AusbildungsgangDto entriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAusbildungsgangDto paginatedAusbildungsgang = (PaginatedAusbildungsgangDto) o;
  ...
  public String toString() {
    ...
    sb.append("class PaginatedAusbildungsgangDto {\n");
