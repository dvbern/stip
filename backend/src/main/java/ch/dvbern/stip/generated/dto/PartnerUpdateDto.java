...
public class PartnerUpdateDto  implements Serializable {
   ...
   **/
  public PartnerUpdateDto jahreseinkommen(BigDecimal jahreseinkommen) {
   ...
   * Required falls ausbildungMitEinkommenOderErwerbstaetig true ist
   **/
  public PartnerUpdateDto fahrkosten(BigDecimal fahrkosten) {
   ...
   * Required falls ausbildungMitEinkommenOderErwerbstaetig true ist
   **/
  public PartnerUpdateDto verpflegungskosten(BigDecimal verpflegungskosten) {
