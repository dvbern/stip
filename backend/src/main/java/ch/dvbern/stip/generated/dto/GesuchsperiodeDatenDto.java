...
public class GesuchsperiodeDatenDto  implements Serializable {
  ...
  /**
   **/
  public GesuchsperiodeDatenDto fristUploadUnterschriftenblatt(Integer fristUploadUnterschriftenblatt) {
   ...
   * dd.MM.yyyy
   **/
  public GesuchsperiodeDatenDto stichtagVolljaehrigkeitMedizinischeGrundversorgung(LocalDate stichtagVolljaehrigkeitMedizinischeGrundversorgung) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bezeichnungDe, gesuchsperiodeDaten.bezeichnungDe) &&
        ...
        Objects.equals(this.fristUploadUnterschriftenblatt, gesuchsperiodeDaten.fristUploadUnterschriftenblatt) &&
  ...
  public static GesuchsperiodeDatenDtoBuilder<?, ?> builder() {
    return new GesuchsperiodeDatenDtoBuilderImpl();
  }

  private static final class GesuchsperiodeDatenDtoBuilderImpl extends GesuchsperiodeDatenDtoBuilder<GesuchsperiodeDatenDto, GesuchsperiodeDatenDtoBuilderImpl> {

    @Override
    protected GesuchsperiodeDatenDtoBuilderImpl self() {
      return this;
    }

    @Override
    public GesuchsperiodeDatenDto build() {
      return new GesuchsperiodeDatenDto(this);
    }
  }

  public static abstract class GesuchsperiodeDatenDtoBuilder<C extends GesuchsperiodeDatenDto, B extends GesuchsperiodeDatenDtoBuilder<C, B>>  {
