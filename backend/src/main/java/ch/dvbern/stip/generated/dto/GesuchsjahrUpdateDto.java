...
public class GesuchsjahrUpdateDto  implements Serializable {
  ...
  /**
   **/
  public GesuchsjahrUpdateDto ausbildungsjahrStart(LocalDate ausbildungsjahrStart) {
  ...
  /**
   **/
  public GesuchsjahrUpdateDto ausbildungsjahrEnde(LocalDate ausbildungsjahrEnde) {
