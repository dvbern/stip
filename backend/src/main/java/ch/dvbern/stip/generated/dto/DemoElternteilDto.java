...
public class DemoElternteilDto  implements Serializable {
  ...
  @NotNull public ch.dvbern.stip.api.eltern.type.ElternTyp getType() {
    return type;
  }
  ...
  /**
   **/
  public DemoElternteilDto geburtsdatum(String geburtsdatum) {
  ...
  /**
   **/
  public DemoElternteilDto alter(Integer alter) {
    this.alter = alter;
    return this;
  }
