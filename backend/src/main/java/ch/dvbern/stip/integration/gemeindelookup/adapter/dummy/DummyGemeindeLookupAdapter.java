...
package ch.dvbern.stip.integration.gemeindelookup.adapter.dummy;
...
@RequestScoped
@GemeindeLookupQualifier(GemeindeLookupAdapterType.DUMMY)
public class DummyGemeindeLookupAdapter implements GemeindeLookupPort {

    @Override
    public Optional<GemeindeData> findGemeindeData(GemeindeLookupRequest request) {
        return Optional.of(GemeindeData.builder().bfsNummer(355).name("Köniz").build());
    }
}
