...
public enum DokumentTyp {
    ...
    EK_BELEG_ALIMENTE, // todo kstip-2780: rename to unterhaltsbeitraege
    EK_BELEG_KINDERZULAGEN,
    EK_VERFUEGUNG_GEMEINDE_INSTITUTION,
    EK_BELEG_BEZAHLTE_RENTEN,
    EK_VERFUEGUNG_ERGAENZUNGSLEISTUNGEN, // todo kstip-2780: remove
    EK_ENTSCHEID_ERGAENZUNGSLEISTUNGEN_EO, // todo kstip-2780: remove
