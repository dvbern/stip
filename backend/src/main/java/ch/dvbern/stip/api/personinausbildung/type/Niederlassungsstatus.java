...
public enum Niederlassungsstatus {
    SAISONARBEITEND_A(1),
    AUFENTHALTSBEWILLIGUNG_B(2),
    NIEDERLASSUNGSBEWILLIGUNG_C(3),
    PARTNER_ERWERBSTAETIG_UND_KIND_CI(4),
    VORLAEUFIG_AUFGENOMMEN_F_OHNE_FLUECHTLINGSSTATUS(5),
    VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_MANDANT(5),
    VORLAEUFIG_AUFGENOMMEN_F_ANDERER_ZUESTAENDIGER_KANTON(5),
    GRENZGAENGIG_G(6),
    KURZAUFENTHALT_L(7),
    ASYLSUCHEND_N(8),
    SCHUTZBEDUERFTIG_S(9),
    MELDEPFLICHTIG(10),
