...
public enum Niederlassungsstatus {
    ...
    public static final Set<Niederlassungsstatus> ALL_VORLAEUFIG_AUFGENOMMEN_MIT_FLUECHTLINGSSTATUS = EnumSet.of(
        VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_MANDANT,
        VORLAEUFIG_AUFGENOMMEN_F_ANDERER_ZUESTAENDIGER_KANTON
    );
    public static final Set<Niederlassungsstatus> ALL_VORLAEUFIG_AUFGENOMMEN = EnumSet.of(
        VORLAEUFIG_AUFGENOMMEN_F_OHNE_FLUECHTLINGSSTATUS,
        VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_MANDANT,
        VORLAEUFIG_AUFGENOMMEN_F_ANDERER_ZUESTAENDIGER_KANTON
    );
