...
@ApplicationScoped
public class SteuererklaerungMutterRequiredDocumentsProducer implements RequiredDocumentsProducer {
    @Override
    public Pair<String, Set<DokumentTyp>> getRequiredDocuments(GesuchFormular formular) {
        ...
        final var requiredDocs = SteuererklaerungRequiredDocumentsProducerUtil
            .getRequiredDocuments(steuererklarungen, SteuerdatenTyp.MUTTER);

        return ImmutablePair.of("steuererklaerungMutter", requiredDocs);
    }
}
