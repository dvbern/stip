...
public class FamiliensituationRequiredDocumentsProducer implements RequiredDocumentsProducer {
    ...
    public Pair<String, Set<DokumentTyp>> getRequiredDocuments(GesuchFormular formular) {
        ...
        if (
            famsit.getMutterUnbekanntGrund() == ElternUnbekanntheitsGrund.FEHLENDE_ANERKENNUNG
            || famsit.getVaterUnbekanntGrund() == ElternUnbekanntheitsGrund.FEHLENDE_ANERKENNUNG
        ) {
