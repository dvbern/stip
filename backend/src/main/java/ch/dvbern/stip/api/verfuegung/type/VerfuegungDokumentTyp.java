...
public enum VerfuegungDokumentTyp {
    ...
    VERFUEGUNG_OHNE_ANSPRUCH,
    NEGATIVE_VERFUEGUNG;

    public static final Set<VerfuegungDokumentTyp> VERFUEGUNGSBRIEF =
        Set.of(VERFUEGUNG_MIT_ANSPRUCH, VERFUEGUNG_OHNE_ANSPRUCH, NEGATIVE_VERFUEGUNG);
}
