...
package ch.dvbern.stip.api.sap.service.endpoints.vendorposting;
...
/**
 * SenderParameter mit Delivery-ID
 *
...
@XmlType(name = "SenderParmsDelivery", namespace = "urn:be.ch:KTBE_ERP_FI:GENERAL", propOrder = {
    "sysid",
    "betrieb",
    "deliveryid",
    "version"
