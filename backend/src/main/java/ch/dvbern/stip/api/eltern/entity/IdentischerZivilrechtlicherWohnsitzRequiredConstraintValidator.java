...
public class IdentischerZivilrechtlicherWohnsitzRequiredConstraintValidator
    ...
    public boolean isValid(
        ...
        if (!eltern.isIdentischerZivilrechtlicherWohnsitz()) {
            return StringUtils.isNotEmpty(eltern.getIdentischerZivilrechtlicherWohnsitzPLZ()) && StringUtils.isNotEmpty(
                eltern.getIdentischerZivilrechtlicherWohnsitzOrt()
            );
        }
        ...
        return eltern.getIdentischerZivilrechtlicherWohnsitzPLZ() == null
        && eltern.getIdentischerZivilrechtlicherWohnsitzOrt() == null;
    }
}
