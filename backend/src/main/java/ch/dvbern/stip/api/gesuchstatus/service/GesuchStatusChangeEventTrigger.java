...
public final class GesuchStatusChangeEventTrigger
extends TriggerWithParameters2<Gesuch, String, GesuchStatusChangeEvent> {

    private GesuchStatusChangeEventTrigger(GesuchStatusChangeEvent underlyingTrigger) {
        super(underlyingTrigger, Gesuch.class, String.class);
    }
