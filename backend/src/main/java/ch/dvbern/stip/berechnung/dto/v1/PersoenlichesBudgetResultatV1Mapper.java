...
public class PersoenlichesBudgetResultatV1Mapper implements PersoenlichesBudgetResultatMapper {
    ...
    public PersoenlichesBudgetresultatDto mapFromRequest(
        ...
        return new PersoenlichesBudgetresultatDto()
            ...
            .ausbildungszulagenKinderTotal(antragssteller.getKinderAusbildungszulagenTotal())
            .unterhaltsbeitraegeKinderTotal(antragssteller.getKinderErhalteneUnterhaltsbeitraegeTotal())
            ...
            .einnahmenBGSA(antragssteller.getEinnahmenBGSA())
            .einnahmenBGSAPartner(antragssteller.getEinnahmenBGSAPartner())
            .einnahmenBGSATotal(antragssteller.getEinnahmenBGSA() + antragssteller.getEinnahmenBGSAPartner())
            ...
            .rentenKinder(antragssteller.getKindRenteIntegerValues())
            .rentenKinderTotal(antragssteller.getKinderRentenTotal())
            .ausbildungszulagenKinder(antragssteller.getKindAusbildungszulagenIntegerValues())
            .andereEinnahmen(antragssteller.getAndereEinnahmen())
            .andereEinnahmenPartner(antragssteller.getAndereEinnahmenPartner())
            ...
            .taggelderTotal(antragssteller.getTaggeldPartner() + antragssteller.getTaggeld())
            .ergaenzungsleistungenKinder(antragssteller.getKindErgaenzungsleistungenIntegerValues())
            .ergaenzungsleistungenTotal(
                antragssteller.getErgaenzungsleistungen() + antragssteller.getErgaenzungsleistungenPartner()
                + antragssteller.getKinderErgaenzungsleistungenTotal()
            )
            .unterhaltsbeitraegeKinder(antragssteller.getKindUnterhaltsbeitraegeIntegerValues())
            .ergaenzungsleistungenPartner(antragssteller.getErgaenzungsleistungenPartner())
