...
public class PersoenlichesBudgetResultatV1Mapper implements PersoenlichesBudgetResultatMapper {
    ...
    public PersoenlichesBudgetresultatDto mapFromRequest(
        ...
        return new PersoenlichesBudgetresultatDto()
            ...
            .ausbildungszulagenKinderTotal(antragssteller.getKinderAusbildungszulagen())
            .unterhaltsbeitraegeKinderTotal(antragssteller.getKinderErhalteneUnterhaltsbeitraege())
            ...
            .einnahmenBGSAPartner(null)
            .einnahmenBGSATotal(null)
            ...
            .rentenKinder(null)
            .rentenKinderTotal(null)
            .ausbildungszulagenKinder(null)
            .andereEinnahmen(antragssteller.getAndereEinnahmen())
            .andereEinnahmenPartner(null)
            .andereEinnahmenKinder(null)
            .andereEinnahmenTotal(null)
            .taggelderPartner(null)
            .taggelder(antragssteller.getTaggeld())
            .taggelderTotal(null)
            .ergaenzungsleistungenKinder(null)
            .ergaenzungsleistungenTotal(null)
            .unterhaltsbeitraegeKinder(null)
            .ergaenzungsleistungenPartner(null)
