...
public class PersoenlichesBudgetresultatKostenDtoSpec {
  ...
  **/
  ...
  public PersoenlichesBudgetresultatKostenDtoSpec medizinischeGrundversorgungPartner(Integer medizinischeGrundversorgungPartner) {
   ...
   /**
   * Get medizinischeGrundversorgungPartner
   * @return medizinischeGrundversorgungPartner
  **/
  @jakarta.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_MEDIZINISCHE_GRUNDVERSORGUNG_PARTNER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
