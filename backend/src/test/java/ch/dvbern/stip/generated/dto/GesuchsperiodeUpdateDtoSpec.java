...
@JsonPropertyOrder({
  ...
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_GESUCHSJAHR,
  ...
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_AUFSCHALTTERMIN_STOPP,
  ...
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_VERMOEGENSFREIBETRAG,
  ...
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_LIMITE_EK_FREIBETRAG_INTEGRATIONSZULAG,
  ...
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_KINDER0018,
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_JUGENDLICHE_ERWACHSENE1925,
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_ERWACHSENE2699,
  ...
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_ANZAHL_WOCHE_LEHRE,
  GesuchsperiodeUpdateDtoSpec.JSON_PROPERTY_ANZAHL_WOCHE_SCHULE
})
...
public class GesuchsperiodeUpdateDtoSpec {
  ...
  public static final String JSON_PROPERTY_ANZAHL_WOCHE_LEHRE = "anzahlWocheLehre";
  private Integer anzahlWocheLehre;

  public static final String JSON_PROPERTY_ANZAHL_WOCHE_SCHULE = "anzahlWocheSchule";
  private Integer anzahlWocheSchule;
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec aufschaltterminStopp(LocalDate aufschaltterminStopp) {
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec vermoegensfreibetrag(Integer vermoegensfreibetrag) {
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec limiteEkFreibetragIntegrationszulag(Integer limiteEkFreibetragIntegrationszulag) {
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec kinder0018(Integer kinder0018) {
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec jugendlicheErwachsene1925(Integer jugendlicheErwachsene1925) {
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec erwachsene2699(Integer erwachsene2699) {
  ...
  **/
  ...
  public GesuchsperiodeUpdateDtoSpec anzahlWocheLehre(Integer anzahlWocheLehre) {
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ANZAHL_WOCHE_LEHRE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public GesuchsperiodeUpdateDtoSpec anzahlWocheSchule(Integer anzahlWocheSchule) {
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ANZAHL_WOCHE_SCHULE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
