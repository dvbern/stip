...
public class SozialdienstBenutzerCreateDtoSpec {
  ...
  public SozialdienstBenutzerCreateDtoSpec vorname(@jakarta.annotation.Nonnull String vorname) {
  ...
  public SozialdienstBenutzerCreateDtoSpec nachname(@jakarta.annotation.Nonnull String nachname) {
  ...
  public SozialdienstBenutzerCreateDtoSpec email(@jakarta.annotation.Nonnull String email) {
