 ...
 */
@JsonPropertyOrder({
  KindUpdateDtoSpec.JSON_PROPERTY_ENTRY_ID,
...
public class KindUpdateDtoSpec {
  ...
  public KindUpdateDtoSpec entryId(@jakarta.annotation.Nonnull UUID entryId) {
  ...
  public KindUpdateDtoSpec vorname(@jakarta.annotation.Nonnull String vorname) {
  ...
  public KindUpdateDtoSpec geburtsdatum(@jakarta.annotation.Nonnull LocalDate geburtsdatum) {
  ...
  public KindUpdateDtoSpec ausbildungssituation(@jakarta.annotation.Nonnull AusbildungssituationDtoSpec ausbildungssituation) {
  ...
  public KindUpdateDtoSpec id(@jakarta.annotation.Nullable UUID id) {
  ...
  public KindUpdateDtoSpec wohnsitzAnteilPia(@jakarta.annotation.Nonnull Integer wohnsitzAnteilPia) {
  ...
  public KindUpdateDtoSpec nachname(@jakarta.annotation.Nonnull String nachname) {
  ...
  public KindUpdateDtoSpec unterhaltsbeitraege(@jakarta.annotation.Nullable Integer unterhaltsbeitraege) {
  ...
  public KindUpdateDtoSpec kinderUndAusbildungszulagen(@jakarta.annotation.Nullable Integer kinderUndAusbildungszulagen) {
  ...
  public KindUpdateDtoSpec renten(@jakarta.annotation.Nullable Integer renten) {
  ...
  public KindUpdateDtoSpec ergaenzungsleistungen(@jakarta.annotation.Nullable Integer ergaenzungsleistungen) {
  ...
  public KindUpdateDtoSpec betreuungskosten(@jakarta.annotation.Nullable Integer betreuungskosten) {
  ...
  public KindUpdateDtoSpec andereEinnahmen(@jakarta.annotation.Nullable Integer andereEinnahmen) {
