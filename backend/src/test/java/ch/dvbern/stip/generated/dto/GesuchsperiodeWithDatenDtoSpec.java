...
@JsonPropertyOrder({
  ...
  GesuchsperiodeWithDatenDtoSpec.JSON_PROPERTY_FREIBETRAG_VERMöGEN,
...
public class GesuchsperiodeWithDatenDtoSpec {
  ...
  **/
  ...
  public GesuchsperiodeWithDatenDtoSpec freibetragVermögen(BigDecimal freibetragVermögen) {
