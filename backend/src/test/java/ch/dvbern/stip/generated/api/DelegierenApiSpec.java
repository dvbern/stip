...
import ch.dvbern.stip.generated.dto.GetDelegierungSozQueryTypeMitarbeiterDtoSpec;
...
public class DelegierenApiSpec {
    ...
    public GetDelegierungsOfSozialdienstAdminOper getDelegierungsOfSozialdienstAdmin() {
        return new GetDelegierungsOfSozialdienstAdminOper(createReqSpec());
    }

    public GetDelegierungsOfSozialdienstMitarbeiterOper getDelegierungsOfSozialdienstMitarbeiter() {
        return new GetDelegierungsOfSozialdienstMitarbeiterOper(createReqSpec());
    }
     ...
     * @see #delegierungIdPath Die ID der Delegierung (required)
     */
    public static class DelegierungAblehnenOper implements Oper {

        public static final Method REQ_METHOD = DELETE;
        public static final String REQ_URI = "/delegierung/{delegierungId}/ablehnen";

        private RequestSpecBuilder reqSpec;
        private ResponseSpecBuilder respSpec;

        public DelegierungAblehnenOper(RequestSpecBuilder reqSpec) {
            this.reqSpec = reqSpec;
            reqSpec.setAccept("text/plain");
            this.respSpec = new ResponseSpecBuilder();
        }
        ...
        /**
         * DELETE /delegierung/{delegierungId}/ablehnen
         * @param handler handler
         * @param <T> type
         * @return type
         */
         ...
         * @return operation
         */
        public DelegierungAblehnenOper delegierungIdPath(Object delegierungId) {
            reqSpec.addPathParam(DELEGIERUNG_ID_PATH, delegierungId);
            return this;
        }
         ...
         * @return operation
         */
        public DelegierungAblehnenOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
     ...
     * return List&lt;DelegierungDtoSpec&gt;
     */
    public static class GetAllDelegierungsForGesuchOper implements Oper {

        public static final Method REQ_METHOD = GET;
        public static final String REQ_URI = "/delegierung/{gesuchId}/all";
         ...
         * @return List&lt;DelegierungDtoSpec&gt;
         */
        public List<DelegierungDtoSpec> executeAs(Function<Response, Response> handler) {
            TypeRef<List<DelegierungDtoSpec>> type = new TypeRef<List<DelegierungDtoSpec>>(){};
         ...
         * @return operation
         */
        public GetAllDelegierungsForGesuchOper gesuchIdPath(Object gesuchId) {
         ...
         * @return operation
         */
        public GetAllDelegierungsForGesuchOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public GetAllDelegierungsForGesuchOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
     ...
     */
    public static class GetDelegierungsOfSozialdienstAdminOper implements Oper {

        public static final Method REQ_METHOD = GET;
        public static final String REQ_URI = "/delegierung/{getDelegierungSozQueryType}/admin";
        ...
        /**
         * GET /delegierung/{getDelegierungSozQueryType}/admin
         * @param handler handler
         * @param <T> type
         * @return type
         */
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper fallNummerQuery(Object... fallNummer) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper nachnameQuery(Object... nachname) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper vornameQuery(Object... vorname) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper geburtsdatumQuery(Object... geburtsdatum) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper pageQuery(Object... page) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper pageSizeQuery(Object... pageSize) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper sortColumnQuery(Object... sortColumn) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper sortOrderQuery(Object... sortOrder) {
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstAdminOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
     ...
     * return PaginatedSozDashboardDtoSpec
     */
    public static class GetDelegierungsOfSozialdienstMitarbeiterOper implements Oper {

        public static final Method REQ_METHOD = GET;
        public static final String REQ_URI = "/delegierung/{getDelegierungSozQueryType}/ma";
        ...
        /**
         * GET /delegierung/{getDelegierungSozQueryType}/ma
         * @param handler handler
         * @param <T> type
         * @return type
         */
        ...
        /**
         * @param getDelegierungSozQueryType (GetDelegierungSozQueryTypeMitarbeiterDtoSpec)  (required)
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper getDelegierungSozQueryTypePath(Object getDelegierungSozQueryType) {
            reqSpec.addPathParam(GET_DELEGIERUNG_SOZ_QUERY_TYPE_PATH, getDelegierungSozQueryType);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper fallNummerQuery(Object... fallNummer) {
            reqSpec.addQueryParam(FALL_NUMMER_QUERY, fallNummer);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper nachnameQuery(Object... nachname) {
            reqSpec.addQueryParam(NACHNAME_QUERY, nachname);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper vornameQuery(Object... vorname) {
            reqSpec.addQueryParam(VORNAME_QUERY, vorname);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper geburtsdatumQuery(Object... geburtsdatum) {
            reqSpec.addQueryParam(GEBURTSDATUM_QUERY, geburtsdatum);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper wohnortQuery(Object... wohnort) {
            reqSpec.addQueryParam(WOHNORT_QUERY, wohnort);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper pageQuery(Object... page) {
            reqSpec.addQueryParam(PAGE_QUERY, page);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper pageSizeQuery(Object... pageSize) {
            reqSpec.addQueryParam(PAGE_SIZE_QUERY, pageSize);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper sortColumnQuery(Object... sortColumn) {
            reqSpec.addQueryParam(SORT_COLUMN_QUERY, sortColumn);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper sortOrderQuery(Object... sortOrder) {
            reqSpec.addQueryParam(SORT_ORDER_QUERY, sortOrder);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public GetDelegierungsOfSozialdienstMitarbeiterOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
