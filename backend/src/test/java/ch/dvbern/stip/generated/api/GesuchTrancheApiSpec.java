...
public class GesuchTrancheApiSpec {
    ...
    public List<Oper> getAllOperations() {
        return Arrays.asList(
                ...
                getGesuchDokument(),
                getGesuchDokumente(),
                getRequiredCustomGesuchDokumentTyp(),
    ...
    public GetRequiredCustomGesuchDokumentTypOper getRequiredCustomGesuchDokumentTyp() {
        return new GetRequiredCustomGesuchDokumentTypOper(createReqSpec());
    }
     ...
     */
    public static class GetRequiredCustomGesuchDokumentTypOper implements Oper {
        ...
        public GetRequiredCustomGesuchDokumentTypOper(RequestSpecBuilder reqSpec) {
            this.reqSpec = reqSpec;
            reqSpec.setAccept("application/json");
            this.respSpec = new ResponseSpecBuilder();
        }
         ...
         * @return operation
         */
        public GetRequiredCustomGesuchDokumentTypOper gesuchTrancheIdPath(Object gesuchTrancheId) {
            reqSpec.addPathParam(GESUCH_TRANCHE_ID_PATH, gesuchTrancheId);
            return this;
        }
         ...
         * @return operation
         */
        public GetRequiredCustomGesuchDokumentTypOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public GetRequiredCustomGesuchDokumentTypOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
