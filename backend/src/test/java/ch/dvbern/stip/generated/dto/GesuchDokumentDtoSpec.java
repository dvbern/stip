...
public class GesuchDokumentDtoSpec {
  ...
  **/
  ...
  public GesuchDokumentDtoSpec kommentars(List<GesuchDokumentKommentarDtoSpec> kommentars) {
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_KOMMENTARS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_KOMMENTARS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKommentars(List<GesuchDokumentKommentarDtoSpec> kommentars) {
    this.kommentars = kommentars;
  }
