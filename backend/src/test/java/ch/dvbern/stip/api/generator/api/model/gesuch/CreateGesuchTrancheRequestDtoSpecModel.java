...
@UtilityClass
public final class CreateGesuchTrancheRequestDtoSpecModel {
    public static CreateGesuchTrancheRequestDtoSpec createGesuchTrancheRequestDtoSpec(final GesuchDtoSpec gesuch) {
        return TestUtil.createUpdateDtoSpec(CreateGesuchTrancheRequestDtoSpec::new, (model) -> {
            ...
            model.setEnd(gesuch.getGesuchTrancheToWorkWith().getGueltigBis().minusMonths(0).with(lastDayOfMonth()));
        });
    }
}
