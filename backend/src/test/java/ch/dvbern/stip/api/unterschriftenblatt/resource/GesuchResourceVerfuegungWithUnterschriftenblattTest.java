...
class GesuchResourceVerfuegungWithUnterschriftenblattTest {
    /*
     * Gesuch is verfuegt, Unterschriftenblaetter will be uploaded later on.
     * Afterwards, Gesuchstatus is set to VERFUEGUNG_VERSENDET
     */
