...
class GesuchResourceTest4 {
    ...
    void testUpdateGesuchEinnahmenKostenSteuern(){
        ...
        gesuchUpdateDTO.getGesuchTrancheToWorkWith().getGesuchFormular().getPartner().getAdresse().setId(adresseId );
        ...
        gesuch = gesuchApiSpec.getGesuch().gesuchIdPath(gesuchId).execute(ResponseBody::prettyPeek)
            ...
            .body()
            .as(GesuchDtoSpec.class);
        assertThat(gesuch.getGesuchTrancheToWorkWith().getGesuchFormular().getEinnahmenKosten().getSteuernKantonGemeinde(), is(((int) 20001 * 0.1)));
    }
