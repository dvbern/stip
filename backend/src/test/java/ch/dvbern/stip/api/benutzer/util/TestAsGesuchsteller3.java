...
@OidcSecurity(
    claims = {
        @Claim(key = "sub", value = GESUCHSTELLER_3_TEST_ID),
        @Claim(key = "family_name", value = "Gesuchstellerin 3"),
        @Claim(key = "given_name", value = "Freni")
    }
)
public @interface TestAsGesuchsteller3 {
}
