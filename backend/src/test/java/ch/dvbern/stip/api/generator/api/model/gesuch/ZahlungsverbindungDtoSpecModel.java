...
public class ZahlungsverbindungDtoSpecModel {
    public static ZahlungsverbindungDtoSpec zahlungsverbindungDtoSpec() {
        return TestUtil.createUpdateDtoSpec(ZahlungsverbindungDtoSpec::new, (model) -> {
