...
export const DOKUMENT_TYP_TO_DOCUMENT_OPTIONS: {
  ...
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_FAMILIE_DESCRIPTION:
    'shared.form.eltern-steuererklaerung.file.AUSBILDUNGSBEITRAEGE_DESCRIPTION_FAMILIE',
  ...
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_MUTTER_DESCRIPTION:
    'shared.form.eltern-steuererklaerung.file.AUSBILDUNGSBEITRAEGE_DESCRIPTION_MUTTER',
  ...
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_VATER_DESCRIPTION:
    'shared.form.eltern-steuererklaerung.file.AUSBILDUNGSBEITRAEGE_DESCRIPTION_VATER',
