...
export const DOKUMENT_TYP_TO_DOCUMENT_OPTIONS: {
  ...
  KINDER_BETREUUNGSKOSTEN: 'shared.form.kinder.file.BETREUUNGSKOSTEN',
  KINDER_BETREUUNGSKOSTEN_DESCRIPTION:
    'shared.form.kinder.file.BETREUUNGSKOSTEN_DESCRIPTION',
