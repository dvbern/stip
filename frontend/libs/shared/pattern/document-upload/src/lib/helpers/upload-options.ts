...
export const DOKUMENT_TYP_TO_DOCUMENT_OPTIONS: {
  ...
  AUSBILDUNG_BESTAETIGUNG_AUSBILDUNGSSTAETTE_DESCRIPTION:
    'shared.form.ausbildung.file.AUSBILDUNGSSTAETTE_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_SAISONARBEITEND_A_DESCRIPTION:
    'shared.form.person.file.SAISONARBEITERBEWILLIGUNG_A_DESCRIPTION',
  PERSON_NIEDERLASSUNGSSTATUS_B:
    'shared.form.person.file.AUFENTHALTSBEWILLIGUNG_B',
  PERSON_NIEDERLASSUNGSSTATUS_B_DESCRIPTION:
    'shared.form.person.file.AUFENTHALTSBEWILLIGUNG_B_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_C_DESCRIPTION:
    'shared.form.person.file.NIEDERLASSUNGSBEWILLIGUNG_C_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_PARTNER_ERWERBSTAETIG_UND_KIND_CI_DESCRIPTION:
    'shared.form.person.file.EHEPARTNERBEWILLIGUNG_CI_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_TENANT:
    'shared.form.person.file.VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_TENANT',
  PERSON_NIEDERLASSUNGSSTATUS_VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_TENANT_DESCRIPTION:
    'shared.form.person.file.VORLAEUFIG_AUFGENOMMEN_F_ZUESTAENDIGER_KANTON_TENANT_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_GRENZGAENGIG_G_DESCRIPTION:
    'shared.form.person.file.GRENZGAENGERBEWILLIGUNG_G_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_KURZAUFENTHALT_L_DESCRIPTION:
    'shared.form.person.file.KURZAUFENTHALTERBEWILLIGUNG_L_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_ASYLSUCHEND_N_DESCRIPTION:
    'shared.form.person.file.ASYLSUCHENDEBEWILLIGUNG_N_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_SCHUTZBEDUERFTIG_S_DESCRIPTION:
    'shared.form.person.file.SCHUTZBEDUERFTIGEBEWILLIGUNG_S_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_MELDEPFLICHTIG_DESCRIPTION:
    'shared.form.person.file.MELDEPFLICHTIGEBEWILLIGUNG_10_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_DIPLOMATISCHE_FUNKTION_DESCRIPTION:
    'shared.form.person.file.DIPLOMATENBEWILLIGUNG_11_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_INTERNATIONALE_FUNKTION_DESCRIPTION:
    'shared.form.person.file.INTERNATIONALEFUNKTIONAERINBEWILLIGUNG_12_DESCRIPTION',
  ...
  PERSON_NIEDERLASSUNGSSTATUS_NICHT_ZUGETEILT_DESCRIPTION:
    'shared.form.person.file.NICHTZUGEWIESEN_13_DESCRIPTION',
  ...
  PERSON_EIGENER_HAUSHALT_DESCRIPTION:
    'shared.form.person.file.EIGENER_HAUSHALT_DESCRIPTION',
  ...
  FAMILIENSITUATION_AUFENTHALT_UNBEKANNT_VATER_DESCRIPTION:
    'shared.form.familiensituation.file.AUFENTHALT_UNBEKANNT_DESCRIPTION',
  ...
  ELTERN_LOHNABRECHNUNG_VERMOEGEN_VATER_DESCRIPTION:
    'shared.form.eltern.file.LOHNABRECHNUNG_VERMOEGEN_DESCRIPTION',
  ...
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_FAMILIE_DESCRIPTION:
    'shared.form.eltern-steuererklaerung.file.AUSBILDUNGSBEITRAEGE_DESCRIPTION',
