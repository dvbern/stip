...
export const DOKUMENT_TYP_TO_DOCUMENT_OPTIONS: {
  ...
  STEUERERKLAERUNG_UNTERHALTSBEITRAEGE_VATER:
    'shared.form.eltern-steuererklaerung.file.STEUERERKLAERUNG_UNTERHALTSBEITRAEGE_VATER',
  STEUERERKLAERUNG_UNTERHALTSBEITRAEGE_MUTTER:
    'shared.form.eltern-steuererklaerung.file.STEUERERKLAERUNG_UNTERHALTSBEITRAEGE_MUTTER',
  STEUERERKLAERUNG_RENTEN_VATER:
    'shared.form.eltern-steuererklaerung.file.STEUERERKLAERUNG_RENTEN_VATER',
  STEUERERKLAERUNG_RENTEN_MUTTER:
    'shared.form.eltern-steuererklaerung.file.STEUERERKLAERUNG_RENTEN_MUTTER',
  STEUERERKLAERUNG_EINNAHMEN_BGSA_VATER:
    'shared.form.eltern-steuererklaerung.file.STEUERERKLAERUNG_EINNAHMEN_BGSA_VATER',
  STEUERERKLAERUNG_EINNAHMEN_BGSA_MUTTER:
    'shared.form.eltern-steuererklaerung.file.STEUERERKLAERUNG_EINNAHMEN_BGSA_MUTTER',
};
