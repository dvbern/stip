...
export const DOKUMENT_TYP_TO_DOCUMENT_OPTIONS: {
  ...
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_FAMILIE:
    'shared.form.steuererklaerung.file.AUSBILDUNGSBEITRAEGE_FAMILIE',
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_MUTTER:
    'shared.form.steuererklaerung.file.AUSBILDUNGSBEITRAEGE_MUTTER',
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_VATER:
    'shared.form.steuererklaerung.file.AUSBILDUNGSBEITRAEGE_VATER',
};
