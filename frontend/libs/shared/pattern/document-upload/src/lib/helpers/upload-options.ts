...
export const DOKUMENT_TYP_TO_DOCUMENT_OPTIONS: {
  ...
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_FAMILIE:
    'shared.form.eltern-steuerdaten.file.STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_FAMILIE',
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_MUTTER:
    'shared.form.eltern-steuerdaten.file.STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_MUTTER',
  STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_VATER:
    'shared.form.eltern-steuerdaten.file.STEUERERKLAERUNG_AUSBILDUNGSBEITRAEGE_VATER',
};
