...
const AbschlussPhaseMap = {
  ...
  TRANCHE_AKZETPIERT /**                      */: { [gs]: S__, [sb]: S__ },
...
export const toAbschlussPhase = (
  ...
  options?: { isComplete?: boolean; checkTranche?: boolean; appType?: AppType },
): AbschlussPhase | null => {
  ...
  return phase === 'READY_TO_SEND' && options?.isComplete ? phase : 'NOT_READY';
};
