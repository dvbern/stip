...
export type DokumentArt = 'GESUCH_DOKUMENT' | 'UNTERSCHRIFTENBLATT' | 'CUSTOM_DOKUMENT' | 'BESCHWERDE_ENTSCHEID' | 'DARLEHEN_DOKUMENT';
...
export const DokumentArt = {
    ...
    DARLEHEN_DOKUMENT: 'DARLEHEN_DOKUMENT' as DokumentArt
};
