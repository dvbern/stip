...
// export const APIS = [AusbildungsstaetteService, BenutzerService, ConfigurationService, FallService, GesuchService, GesuchsjahrService, GesuchsperiodeService, StammdatenService, TenantService];
