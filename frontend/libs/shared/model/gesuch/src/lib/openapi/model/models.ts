...
export * from './adresse';
export * from './aenderungenWithVerfuegung';
export * from './aenderungenWithVerfuegungAllOf';
export * from './anrede';
...
export * from './gesuchHeaderGs';
export * from './gesuchHeaderGsAllOf';
export * from './gesuchHeaderSb';
export * from './gesuchHeaderSbAllOf';
...
export * from './historizedTranchen';
...
export * from './tranchenWithVerfuegung';
