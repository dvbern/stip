...
export class AusbildungsstaetteService {
     ...
     */
     public createAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceCreateAusbildungsstaetteRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext}): Observable<any>;
     public createAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceCreateAusbildungsstaetteRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext}): Observable<HttpResponse<any>>;
     public createAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceCreateAusbildungsstaetteRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext}): Observable<HttpEvent<any>>;
     public createAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceCreateAusbildungsstaetteRequestParams, observe: 'body' | 'response' | 'events' = 'body', reportProgress = false, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
     public updateAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceUpdateAusbildungsstaetteRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<any>;
     public updateAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceUpdateAusbildungsstaetteRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpResponse<any>>;
     public updateAusbildungsstaette$(requestParameters: AusbildungsstaetteServiceUpdateAusbildungsstaetteRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpEvent<any>>;
