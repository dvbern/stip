...
export interface GesuchServiceChangeGesuchStatusToDatenschutzbriefAmGenerierenRequestParams {
    gesuchTrancheId: string;
}
...
export interface GesuchServiceChangeGesuchStatusToVerfuegungAmGenerierenRequestParams {
    gesuchTrancheId: string;
}
...
export class GesuchService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
     public changeGesuchStatusToDatenschutzbriefAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToDatenschutzbriefAmGenerierenRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<GesuchWithChanges>;
     public changeGesuchStatusToDatenschutzbriefAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToDatenschutzbriefAmGenerierenRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpResponse<GesuchWithChanges>>;
     public changeGesuchStatusToDatenschutzbriefAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToDatenschutzbriefAmGenerierenRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpEvent<GesuchWithChanges>>;
     public changeGesuchStatusToDatenschutzbriefAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToDatenschutzbriefAmGenerierenRequestParams, observe: 'body' | 'response' | 'events' = 'body', reportProgress = false, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<any> {
        const gesuchTrancheId = requestParameters.gesuchTrancheId;
        if (gesuchTrancheId === null || gesuchTrancheId === undefined) {
            throw new Error('Required parameter gesuchTrancheId was null or undefined when calling changeGesuchStatusToDatenschutzbriefAmGenerieren$.');
        }
        ...
        const localVarPath = `/gesuch/status/datenschutzbrief-generieren/${this.configuration.encodeParam({name: "gesuchTrancheId", value: gesuchTrancheId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}`;
        return this.httpClient.request<GesuchWithChanges>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
     public changeGesuchStatusToVerfuegungAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToVerfuegungAmGenerierenRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<GesuchWithChanges>;
     public changeGesuchStatusToVerfuegungAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToVerfuegungAmGenerierenRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpResponse<GesuchWithChanges>>;
     public changeGesuchStatusToVerfuegungAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToVerfuegungAmGenerierenRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpEvent<GesuchWithChanges>>;
     public changeGesuchStatusToVerfuegungAmGenerieren$(requestParameters: GesuchServiceChangeGesuchStatusToVerfuegungAmGenerierenRequestParams, observe: 'body' | 'response' | 'events' = 'body', reportProgress = false, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<any> {
        const gesuchTrancheId = requestParameters.gesuchTrancheId;
        if (gesuchTrancheId === null || gesuchTrancheId === undefined) {
            throw new Error('Required parameter gesuchTrancheId was null or undefined when calling changeGesuchStatusToVerfuegungAmGenerieren$.');
        }
        ...
        const localVarPath = `/gesuch/status/verfuegung-generieren/${this.configuration.encodeParam({name: "gesuchTrancheId", value: gesuchTrancheId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}`;
        return this.httpClient.request<GesuchWithChanges>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
