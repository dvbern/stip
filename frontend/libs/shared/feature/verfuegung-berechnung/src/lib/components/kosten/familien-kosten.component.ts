...
@Component({
  ...
  template: `
    <ng-container
      *transloco="let t; prefix: 'shared.verfuegung.berechnung.familien.kosten'"
    >
      ...
      <div
        ...
        [dialogTitleKeySig]="'shared.verfuegung.berechnung.hinweis.hoechstwerte.title'"
        [dialogMessageKeySig]="'shared.verfuegung.berechnung.hinweis.hoechstwerte.message'"
